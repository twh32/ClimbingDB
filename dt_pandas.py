...
corr_matrix = quant_df.drop(["grade"], axis=1).corr()
...
# Show plot
plt.show()
# This code moves the legend to the upper left outside of the plot area. The bbox_to_anchor parameter helps to adjust the exact position of the legend box relative to the plot. Also, subplots_adjust is used to make room for the legend so it doesn't overlap with the plot.
